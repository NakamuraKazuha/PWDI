...
def create_emergency_interface(page):
    ...
    # ✅ Home and Profile Icons (Fixed!)
    top_bar = ft.Container(
        padding=ft.padding.only(left=20, right=20, top=10),
        content=ft.Row(
            [
                ft.IconButton(icon=ft.icons.HOME, icon_size=40, icon_color="#085F61"),
                ft.Container(expand=1),
                ft.IconButton(icon=ft.icons.PERSON, icon_size=40, icon_color="#085F61"),
            ],
    ...
    emergency_container = ft.Stack(
        [
            ...
            ft.Column(
                [
                    top_bar,  # ✅ Fixed Top Bar with Icons
